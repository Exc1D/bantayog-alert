...
Round 1 of the QA staging pass. 4 issues from the 10-subagent test sweep,
intentionally narrow at 3 source files — broader a11y `<main>` sweep across
non-shell pages booked as a follow-up.
