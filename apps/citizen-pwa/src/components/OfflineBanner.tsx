import type { SubmissionState } from '../hooks/useSubmissionMachine'

const BANNER_CONFIG: Record<string, { message: string; bg: string; fg: string }> = {
  submitting: { message: 'Sending\u2026', bg: 'var(--color-surface)', fg: 'var(--color-primary)' },
  server_confirmed: {
    message: 'Received!',
