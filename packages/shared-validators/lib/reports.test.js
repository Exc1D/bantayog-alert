...
describe('reportPrivateDocSchema', () => {
    it('accepts a canonical private report', () => {
        expect(reportPrivateDocSchema.parse({
            municipalityId: 'daet',
            reporterUid: 'uid-123',
            isPseudonymous: true,
...
describe('reportSharingDocSchema', () => {
    it('accepts a sharing config', () => {
        expect(reportSharingDocSchema.parse({
...
describe('reportContactsDocSchema', () => {
    it('accepts a contacts doc', () => {
        expect(reportContactsDocSchema.parse({
            reportId: 'r-1',
            reporterUid: 'uid-1',
            reporterName: 'Juan',
...
describe('reportInboxDocSchema', () => {
    it('accepts an inbox item', () => {
        expect(reportInboxDocSchema.parse({
            reporterUid: 'uid-1',
            clientCreatedAt: ts,
            idempotencyKey: 'k1',
            publicRef: 'a1b2c3d4',
