...
const firebaseStorageUrl = z
    ...
    .url()
    .refine((val) => val.startsWith('https://firebasestorage.googleapis.com/') ||
    val.startsWith('https://storage.googleapis.com/'), {
    message: 'Must be a Firebase Storage URL (https://firebasestorage.googleapis.com/...) or GCS URL (https://storage.googleapis.com/...)',
});
