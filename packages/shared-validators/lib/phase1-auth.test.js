...
import { activeAccountSchema, alertSchema, claimRevocationSchema, minAppVersionSchema, setStaffClaimsInputSchema, suspendStaffAccountInputSchema, } from './index.js';
describe('activeAccountSchema', () => {
    it('accepts an active municipal admin record', () => {
        expect(activeAccountSchema.parse({
            uid: 'admin-1',
...
describe('claimRevocationSchema', () => {
    it('requires a revocation timestamp and reason', () => {
        expect(claimRevocationSchema.parse({
            uid: 'admin-1',
...
describe('setStaffClaimsInputSchema', () => {
    it('requires municipality scope for municipal admins', () => {
        expect(() => setStaffClaimsInputSchema.parse({
            uid: 'admin-1',
            role: 'municipal_admin',
...
describe('suspendStaffAccountInputSchema', () => {
    it('accepts a suspension payload', () => {
        expect(suspendStaffAccountInputSchema.parse({
            uid: 'admin-1',
            reason: 'suspended',
...
describe('minAppVersionSchema', () => {
    it('parses the phase 1 config document', () => {
        expect(minAppVersionSchema.parse({
            citizen: '0.1.0',
            admin: '0.1.0',
            responder: '0.1.0',
            updatedAt: 1713350400000,
...
//# sourceMappingURL=phase1-auth.test.js.map