...
describe('hashMsisdn', () => {
  ...
  it('is deterministic across calls', () => {
    expect(hashMsisdn('+639171234567', 'salt-a-very-long')).toBe(
      hashMsisdn('+639171234567', 'salt-a-very-long'),
    )
  })

  it('salt changes the output', () => {
    expect(hashMsisdn('+639171234567', 'salt-a-very-long')).not.toBe(
      hashMsisdn('+639171234567', 'salt-b-very-long'),
    )
  })
  ...
  it('throws for non-string salt at runtime', () => {
    expect(() => hashMsisdn('+639171234567', null as unknown as string)).toThrow('string salt')
  })
