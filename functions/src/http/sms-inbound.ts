...
export async function smsInboundWebhookCore(
  deps: SmsInboundWebhookCoreDeps,
): Promise<SmsInboundWebhookCoreResult> {
  ...
  const raw = body as { from?: unknown; message?: unknown; id?: unknown } | null
