...
export async function unpublishReportCore(db, deps) {
    ...
    const { result } = await withIdempotency(db, {
        ...
        if (fromVisibilityClass !== 'public_alertable') {
            throw new BantayogError(BantayogErrorCode.FAILED_PRECONDITION, 'unpublishReport is only valid for public reports', { reportId: deps.reportId, fromVisibilityClass });
        }
...
//# sourceMappingURL=unpublish-report.js.map