...
const requestSchema = z
    ...
    .strict();
export async function shareReportCore(db, deps) {
    ...
    const { result } = await withIdempotency(db, {
        ...
        return db.runTransaction(async (tx) => {
            ...
            const existing = existingData?.sharedWith;
            ...
            const opsData = opsReadSnap.data();
...
export const shareReport = onCall({ region: 'asia-southeast1', enforceAppCheck: process.env.NODE_ENV === 'production' }, async (req) => {
...
//# sourceMappingURL=share-report.js.map