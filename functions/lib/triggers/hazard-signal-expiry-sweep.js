...
export const hazardSignalExpirySweep = onSchedule({ schedule: 'every 5 minutes', region: 'asia-southeast1', timeZone: 'UTC' }, async () => {
    await hazardSignalExpirySweepCore({ db: getFirestore() });
});
//# sourceMappingURL=hazard-signal-expiry-sweep.js.map