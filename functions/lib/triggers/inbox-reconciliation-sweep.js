        ...
        try {
            ...
            if (incidentSnap.exists) {
                ...
                await input.db.runTransaction(async (tx) => {
                    ...
                    if (claimStartedAt === null || latest?.processingStartedAt !== claimStartedAt)
                        return;
                    tx.update(claimRef, {
...
export const inboxReconciliationSweep = onSchedule({
    ...
    log({
        severity: result.processed > 3 || (result.oldestAgeMs !== null && result.oldestAgeMs > 15 * 60 * 1000)
            ? 'ERROR'
            : 'INFO',
...
//# sourceMappingURL=inbox-reconciliation-sweep.js.map