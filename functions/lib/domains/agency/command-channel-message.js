...
export const addCommandChannelMessage = onCall({ region: 'asia-southeast1', enforceAppCheck: shouldEnforceAppCheck(), maxInstances: 10 }, async (req) => {
...
//# sourceMappingURL=command-channel-message.js.map