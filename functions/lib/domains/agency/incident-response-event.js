...
export const recordIncidentResponseEvent = onCall({ region: 'asia-southeast1', enforceAppCheck: shouldEnforceAppCheck(), maxInstances: 10 }, async (request) => {
...
//# sourceMappingURL=incident-response-event.js.map