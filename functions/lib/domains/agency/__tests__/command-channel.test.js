...
import { addCommandChannelMessageCore } from '../command-channel-message.js';
...
async function seedThread(id, participants) {
...
describe('addCommandChannelMessage', () => {
    itif(available)('rejects a caller whose UID is not in thread participantUids', async () => {
        ...
        await expect(addCommandChannelMessageCore(adminDb, {
            threadId: 'th1',
            body: 'Hello',
            actor,
...
//# sourceMappingURL=command-channel.test.js.map