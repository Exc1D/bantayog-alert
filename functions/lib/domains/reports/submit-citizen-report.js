...
import { z } from 'zod';
import { BantayogError, BantayogErrorCode, inboxPayloadSchema, } from '@bantayog/shared-validators';
...
async function resolveMunicipality(db, payload) {
    ...
    if (payload.municipalityId) {
        ...
        return {
            ...
            municipalityLabel: typeof muniData?.label === 'string' ? muniData.label : payload.municipalityId,
...
//# sourceMappingURL=submit-citizen-report.js.map