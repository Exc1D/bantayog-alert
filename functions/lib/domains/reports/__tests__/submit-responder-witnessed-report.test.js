...
import { submitResponderWitnessedReport, submitResponderWitnessedReportCore, } from '../submit-responder-witnessed-report.js';
...
beforeAll(async () => {
    ...
    }, 'submit-responder-witnessed-report');
    testEnv = guarded.env;
...
describe('submitResponderWitnessedReportCore', () => {
    itif(available)('creates a responder-witnessed report for an active dispatch', async () => {
