...
describe('mergeDuplicatesCore', () => {
    ...
    it('rejects when report_ops docs are missing', async () => {
        ...
        const result = await mergeDuplicatesCore(mockDb, {
            primaryReportId: 'r1',
            duplicateReportIds: ['r2'],
            idempotencyKey: '00000000-0000-4000-8000-000000000001',
        }, baseActor);
    ...
    it('succeeds and merges duplicates for valid input', async () => {
        ...
        const primaryUpdate = mockDb._txUpdate.mock.calls.find((call) => call[0].path === 'reports/r1');
        ...
        const dupUpdate = mockDb._txUpdate.mock.calls.find((call) => call[0].path === 'reports/r2');
...
//# sourceMappingURL=merge-duplicates.unit.test.js.map