...
describe('duplicateClusterTrigger', () => {
    ...
    itif(available)('sets duplicateClusterId on both reports when same type + muni + within geohash proximity + within 2h', async () => {
    ...
    itif(available)('assigns the same existing clusterId when a third report joins a cluster', async () => {
