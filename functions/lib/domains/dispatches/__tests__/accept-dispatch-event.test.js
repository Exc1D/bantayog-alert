...
describe('acceptDispatch notification_delivered event', () => {
    ...
    it('writes notification_delivered event with action accepted', async () => {
        await acceptDispatchCore({ collection: mockDbCollection, doc: mockDbDoc, runTransaction: mockDbRunTransaction }, {
...
//# sourceMappingURL=accept-dispatch-event.test.js.map