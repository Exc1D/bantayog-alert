...
describe('declineDispatch notification_delivered event', () => {
    ...
    it('writes notification_delivered event with action declined', async () => {
        await declineDispatchCore({ collection: mockDbCollection, doc: mockDbDoc, runTransaction: mockDbRunTransaction }, {
        ...
        if (!deliveredEvent)
            throw new Error('notification_delivered event not found');
...
//# sourceMappingURL=decline-dispatch-event.test.js.map