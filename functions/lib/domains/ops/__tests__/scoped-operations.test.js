...
describe('listScopedOperationsMapCore', () => {
    itif(available)('returns municipal scoped incidents and excludes out-of-scope reports', async () => {
    ...
    itif(available)('rejects a caller without a scoped admin role', async () => {
        await expect(listScopedOperationsMapCore(adminDb, {
            uid: 'citizen-1',
            claims: {
                role: 'citizen',
                accountStatus: 'active',
...
//# sourceMappingURL=scoped-operations.test.js.map